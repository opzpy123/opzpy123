...
public class Chatbot {
    ...
    public Chatbot() {
        ...
        config.put("email", PropertiesConfig.CHAT_GPT_EMAIL);
        config.put("password", PropertiesConfig.CHAT_GPT_PASSWORD);
        config.put("session_token", PropertiesConfig.CHAT_GPT_SESSION_TOKEN);
        this.config=config;
